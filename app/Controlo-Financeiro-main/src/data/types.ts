...
export type ReciboSalarioTipo = "honorario" | "adiantamento";
...
export type ReciboSalario = {
  ...
  iban?: string;
  criadoEm: string;
  /** honorario = recibo do mês; adiantamento = pagamento antecipado */
  tipo?: ReciboSalarioTipo;
  /** Código anti-falsificação impresso no recibo (ex.: RH-202609-K7M2-41) */
  codigoVerificacao?: string;
  notas?: string;
};
